function nn=sleepnn(nn, numiterations, opts, sleep_opts, sleep_input)
dt = opts.dt;
...
W_old = nn.W; 
numfeatures = size(sleep_input,1);
...
for t=1:numiterations
        ...
        spike_snapshot = rand(784,1) * rescale_fac/2;
        spike_snapshot = rand(numfeatures,1) * rescale_fac/2;
        if mod(t,100)<10
            inp_image = spike_snapshot <= 0 ; %sleep_input(:,t);
        else
